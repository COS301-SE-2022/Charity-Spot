                ...
                return(
                    ...
                    <div key={comment.id} className='pcomment'><b><p>{comment.name}</p></b><br></br>
                        <div className="ratedsmall"> 
                            <input type="radio" id="star555" name={comment.id + " 5"} value="5" checked = {comment.rating[4]} disabled />
                            <label htmlFor="star555" title="text"></label>
                            <input type="radio" id="star444" name={comment.id + " 4"} value="4"  checked = {comment.rating[3]} disabled/>
                            <label htmlFor="star444"title="text"></label>
                            <input type="radio" id="star333" name={comment.id + " 3"} value="3"  checked = {comment.rating[2]} disabled />
                            <label  htmlFor="star333" title="text"></label>
                            <input type="radio" id="star222" name={comment.id + " 2"} value="2"  checked = {comment.rating[1]} disabled/>
                            <label  htmlFor="star222" title="text"></label>
                            <input type="radio" id="star111" name={comment.id + " 1"} value="1"  checked = {comment.rating[0]} disabled/>
                            <label  htmlFor="star111" title="text"></label>
                      </div> 
                      <br></br>
                      <p>{comment.comment}</p> 
                  </div> 

...
export function ClientDonate() {
  ...
  const [invalidDonate, setInvalidDonate] = useState('');
  ...
  return (
    <div>
      <div className="wrapper2">
        ...
        <nav>
          <label htmlFor="donate1" className="donate1">
            <FaDonate /> Donate{' '}
          </label>
                ...
                <div className="donate-left">
                  ...
                  <div className="imgWrap">
                    <div className="item-pic">
                      <img
                        src={imageURL}
                        alt="Your uploaded picture will show here"
                        id="donation-pic"
                      />
                    </div>
                    ...
                    >
                      ...
                      <div className="donate-box3">
                        ...
                        >
                          ...
                          <option value="Tech">
                            Tech (phone,laptop,etc..)
                          </option>
                          <option value="Stationary">
                            Stationery (books,pencils,etc..)
                          </option>
                          <option value="Hygiene">
                            Hygiene (soap,pads,etc..)
                          </option>
                          <option value="Furniture">
                            Furniture (Tv,desk,etc..)
                          </option>
                          <option value="Kitchen">
                            Kitchen (kettle,toaster,etc..)
                          </option>
                        </select>
